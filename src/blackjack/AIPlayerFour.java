 ...
 * @author tj
 */
public class AIPlayerFour extends AIPlayer
{
    public AIPlayerFour(JFrame cardBoard, ArrayList<Integer> fiftyTwoList)
    {
    ...
    public void paint(Graphics g, Painter canvas)
    {
        ...
        Point pointHolder = new Point(youLocationX, player3LocationY);
