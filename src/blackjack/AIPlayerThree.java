 ...
 * @author tj
 */
public class AIPlayerThree extends AIPlayer
{
    public AIPlayerThree(JFrame cardBoard, ArrayList<Integer> fiftyTwoList)
    {
    ...
    public void paint(Graphics g, Painter canvas)
    {
        ...
        Point pointHolder = new Point(player1LocationX, player3LocationY);
